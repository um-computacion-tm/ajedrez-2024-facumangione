...
class VerificarReina(unittest.TestCase):
    ...
    def test_direcciones_reina(self):
        ...
        self.assertEqual(reina._queen_king_directions, direcciones_esperadas)
    ...
    def test_queen_init_color(self):
        ...
        self.assertEqual(reina_blanca._color_, 'WHITE')
        self.assertEqual(reina_negra._color_, 'BLACK')
