...
class Chess:
    ...
    def get_board(self):
        ...
        return self._tablero_.get_board_state()

    # En este metodo habría que añadir una validación para que no se mueva una pieza que no corresponde (turno invalido)
    ...
    def realizar_movimiento(self, fila_origen, columna_origen, fila_destino, columna_destino):
       # Función que maneja el movimiento de una pieza en el tablero.
        try:
            ...
            if not self._tablero_.is_valid_move(fila_origen, columna_origen, fila_destino, columna_destino):
                raise InvalidPieceMoveError()
            
            self._tablero_.move_piece(fila_origen, columna_origen, fila_destino, columna_destino)
